...
//Play/Pause Actions
masterPlay.addEventListener('click',(props)=>{
...
document.getElementById('next').addEventListener('click', (props)=>{
       if(songIndex>=9){
         songIndex=0;
       }else{
         songIndex += 1;
...
document.getElementById('previous').addEventListener('click', (props)=>{
  if(songIndex<=0){
    songIndex=0;
  }else{
    songIndex -= 1;
